import { CheckIcon } from '@heroicons/react/20/solid'; // Need to check heroicons
...
const tiers = [
  {
    ...
    href: '#',
    priceMonthly: '$0',
    description: 'Perfect for getting started with tracking.',
    features: ['Basic workout logging', 'Limited history', 'Community support'],
    featured: false,
  },
  {
    name: 'Pro Athlete',
    ...
    href: '#',
    priceMonthly: '$15',
    description: 'Advanced analytics and unlimited history.',
    features: [
        ...
        <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-white/10 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
          <div className="p-8 sm:p-10 lg:flex-auto">
            ...
            <p className="mt-6 text-base leading-7 text-gray-400">
              Get full access to all future updates and premium features for a one-time payment. Limited time offer.
            </p>
            ...
            >
              {['Private forum access', 'Member resources', 'Entry to annual conference', 'Official member t-shirt'].map(
                (feature) => (
