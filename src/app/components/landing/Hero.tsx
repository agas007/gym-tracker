...
export default function Hero() {
  return (
    <div className="relative isolate pt-14">
      ...
      <div className="py-24 sm:py-32 lg:pb-40 text-center">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-16 flow-root sm:mt-24">
            <div className="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
               {/* Placeholder for App Screenshot/Dashboard Mockup */}
              <div className="aspect-[16/9] w-full rounded-md bg-white/5 shadow-2xl ring-1 ring-white/10 flex items-center justify-center text-gray-500">
